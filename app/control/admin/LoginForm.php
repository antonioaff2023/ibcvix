...
class LoginForm extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        if (!empty($ini['login']['logo']))
        {
            ...
            $logo->style = 'margin:auto;max-width: 70px';

            $titulo = "<div style='width: 120%; display: flex; text-align: center;  justify-content: center; align-items: center;'><span>$logo</span><span style='padding-left: 10px;'>IDENTIFICAÇÃO</span></div>";
