...
else
{
    ...
    {
        $slides     = file_get_contents("app/resources/carousel.html");
$anoatual = date('Y');
$rodape = "<span style='width: 100%;'><strong>© $anoatual - IGREJA BATISTA CENTRAL DE VITÓRIA</strong></span>";
...
$content     = str_replace('{rodape}', $rodape, $content);
